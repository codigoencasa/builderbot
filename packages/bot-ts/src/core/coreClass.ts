...
class CoreClass extends EventEmitter {
    ...
    handleMsg = async (messageCtxInComming: { from: string; ref?: string; body?: string }) => {
        ...
        const createCtxMessage = (payload: { body: any; answer: any; media: null; buttons: any[]; capture: boolean; delay: number; keyword: null }, index = 0) => {
        ...
        const flowDynamic =
            (flag: { endFlow?: boolean; fallBack?: boolean; flowDynamic: any; gotoFlow?: boolean }, inRef: any, privateOptions: { [x: string]: any; omitEndFlow?: any; idleCtx?: any }) =>
