...
Los flujos hacen referencia al hecho de construir un flujo de conversacion. Esto es un flow podemos observar que estan presentes dos metodos importantes **[addKeyword](/docs/add-keyword)** y **[addAnswer](/docs/add-answers)**.

Tan sencillo como decir **palabra/s clave** y **mensaje a responder**

Ambos metodos **[addKeyword](/docs/add-keyword)** y **[addAnswer](/docs/add-answers)** tienen una serie opciones disponibles.
